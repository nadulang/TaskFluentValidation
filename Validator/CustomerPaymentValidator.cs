...
{
    public class CustomerPaymentValidator : AbstractValidator<Payments>
    {
        public CustomerPaymentValidator()
        {
            ...
            RuleFor(x => Convert.ToInt32(x.data.attributes.exp_month)).ExclusiveBetween(1, 12).WithMessage("exp_month is between 1-12");
